...
window.Updater = (function () {
  ...
  function banner(remote) {
    ...
    bar.innerHTML = "<b>Update available</b> — this table is v" + window.CS_VERSION + ", GitHub is v" + remote.version + ". Close the browser and run <code>update.bat</code>. <button type=\"button\" id=\"upd-dismiss\">Later</button>";
