...
window.Updater = (function () {
  ...
  function banner(remote) {
    ...
    bar.innerHTML = "<b>Update available</b> — you have v" + window.CS_VERSION + ", GitHub has v" + remote.version + ". Close the game and double-click <code>update.bat</code>. <button type=\"button\" id=\"upd-dismiss\">Later</button>";
